...
public interface Collection<T> {
	 ...
	 * 
	 * @param value a T type value to be added into this collection.
	 */
	void add(T value);

	/**
	 * A method that checks whether the given {@code value} exist in the collection,
	 * as determined by {@link Object#equals(Object)} method. {@code value} can be
	 * {@code null}.
	 * 
	 * @param value an Object value to be checked.
	 ...
	 *         method {@link Object#equals(Object)} and removes one occurrence of it.
	 */
	 ...
	 * 
	 * @param other an collection from where elements are copied.
