...
import hr.fer.zemris.java.hw17.jvdraw.tool.FTriangleTool;
...
public class JVDraw extends JFrame {
	...
	private void initProperties() {
		...
		triangleBtn = new ToolButton("Filled triangle");
	...
	private void buttonListeners() {
		...
		triangleBtn.addActionListener(l -> currentTool = new FTriangleTool(model, canvas, fgColor, bgColor));
	}
				...
				if (e.getClickCount() == 2) {
					...
					if (index >= 0) {
						while (true) {
							...
							int answer = JOptionPane.showConfirmDialog(JVDraw.this, editor, "Edit properties",
